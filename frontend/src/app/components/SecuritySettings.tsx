...
export default function SecuritySettings() {
  ...
  return (
    <div className="space-y-8 max-w-2xl pb-16">
      ...
      {/* Delete Account Card (Updated to Danger Zone style) */}
      <div className="rounded-lg border border-red-600 bg-red-50 p-6 shadow-sm dark:border-red-800 dark:bg-red-900/10">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                Permanently delete your account and all cameras. This action
                cannot be undone.
              </p>
            </div>
          </div>

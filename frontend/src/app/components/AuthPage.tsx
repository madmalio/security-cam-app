...
import { User } from "@/app/types"; // <-- Import shared type
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full rounded-md border border-gray-300 p-2.5 pl-10 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
              />
            </div>
          </div>
          <div className="mb-6">
